# Generated by Django 3.2 on 2021-07-20 04:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_posts', models.ManyToManyField(blank=True, related_name='like_users', to='gibumeapp.Perfume')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='gibumeapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
